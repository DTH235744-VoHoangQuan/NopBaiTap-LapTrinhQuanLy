...
using QuanLyBanHang.Data.Class;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (xuLyThem)
                {
                    ...
                    sp.LoaiSanPham = cboLoaiSanPham.SelectedItem as LoaiSanPham;
                    sp.HangSanXuat = cboHangSanXuat.SelectedItem as HangSanXuat;
...
DialogResult.Yes)
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "SanPham" + DateTime.Now.ToShortDateString().Replace("/", "_") + ".xlsx";
